...
void* PackSkeletalMeshFile(const Siege::String& filePath, const Siege::String& assetsPath)
{
    ...
    CC_LOG_INFO("Reading skeletal mesh for file {} with node path {}", it->second, requestedNodePath)
...
//    Siege::SkeletalMeshData* skeletalMeshData = Siege::SkeletalMeshData::Create(indices, vertices);
