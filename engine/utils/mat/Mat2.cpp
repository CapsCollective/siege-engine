...
const Mat2 Mat2::Identity = {1.f, 0.f, 0.f, 1.f};
const Mat2 Mat2::Zero = {};

// Static functions

Mat2 Mat2::Add(const Mat2& lhs, const Mat2& rhs)
{
    Mat2 newMat {lhs};
    newMat.Add(rhs);
    return newMat;
...
Mat2 Mat2::Subtract(const Mat2& lhs, const Mat2& rhs)
{
    Mat2 newMat {lhs};
    newMat.Subtract(rhs);
    return newMat;
...
Mat2 Mat2::Multiply(const Mat2& lhs, const float& scalar)
{
    Mat2 newMat {lhs};
...
Mat2 Mat2::Divide(const Mat2& lhs, const Mat2& rhs)
{
    return (lhs.Inverse() * rhs);
}

void Mat2::Divide(const Mat2& other)
{
    *this = Mat2::Divide(*this, other);
}
...
void Mat2::Multiply(const float& scalar)
{
...
const float& Mat2::Get(const size_t& rowIndex, const size_t& colIndex)
{
...
{
    return Mat2::Add(lhs, rhs);
}

Mat2 operator-(const Mat2& lhs, const Mat2& rhs)
{
    return Mat2::Subtract(lhs, rhs);
}

Mat2 operator*(const Mat2& lhs, const float& scalar)
{
    return Mat2::Multiply(lhs, scalar);
}

Mat2 operator*(const Mat2& lhs, const Mat2& rhs)
{
    return Mat2::Multiply(lhs, rhs);
}

Mat2 operator/(const Mat2& lhs, const Mat2& rhs)
{
    return Mat2::Divide(lhs, rhs);
}
