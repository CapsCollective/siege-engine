 ...
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec2&, const Vec2&)
/**
 ...
 * @param rhs the vector to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec2&, const Vec3&)
/**
 ...
 * @param rhs the vector to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec2&, const Vec4&)
 ...
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec2&, float)
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec2, const Vec2&, const Vec2&)
/**
 ...
 * @return a new Vec2 with the result of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec2, const Vec2&, const Vec3&)
/**
 ...
 * @return a new Vec2 with the result of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec2, const Vec2&, const Vec4&)
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec2, const Vec2&, float)
/**
 * A + scalar operator. Adds a scalar to all vector elements
 ...
 * @return a new Vec2 with the results of the scalar addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec2, float, const Vec2&)
 ...
 */
DECL_BINARY_OP_NO_IMP(==, bool, const Vec2&, const Vec2&)
/**
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec3, const Vec3&, const Vec2&)
/**
 ...
 * @return a new Vec3 with the results of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec3, const Vec3&, const Vec3&)
/**
 ...
 * @return a new Vec3 with the results of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec3, const Vec3&, const Vec4&)
/**
 * A + scalar operator. Divides a scalar by all vector elements
 * @param lhs a 3D vector to be added to
 * @param rhs a scalar value to add to all elements
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec3, const Vec3&, float)
/**
 * A + scalar operator. Divides a scalar by all vector elements
 * @param lhs a scalar value to add to all elements
 ...
 * @return a new Vec3 with the results of the scalar addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec3, float, const Vec3&)
 ...
 * @return true if the two vectors contain the same elements, false otherwise
 */
DECL_BINARY_OP_NO_IMP(==, bool, const Vec3&, const Vec3&)
/**
 ...
 * @param rhs the vector to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec4&, const Vec2&)
/**
 ...
 * @param rhs the vector to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec4&, const Vec3&)
/**
 ...
 * @param rhs the vector to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec4&, const Vec4&)
/**
 ...
 * @param rhs the scalar value to be added
 */
DECL_BINARY_OP_NO_IMP(+=, void, Vec4&, float)
/**
 ...
 * @return a new Vec3 with the results of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec4, const Vec4&, const Vec2&)
/**
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec4, const Vec4&, const Vec3&)
/**
 ...
 * @return a new Vec4 with the results of the addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec4, const Vec4&, const Vec4&)
/**
 * A + scalar operator. Adds a scalar to all vector elements
 * @param lhs a 4D vector to be added to
 * @param rhs a scalar value to add to all elements
 ...
 */
DECL_BINARY_OP_NO_IMP(+, Vec4, const Vec4&, float)
/**
 * A + scalar operator. Adds a scalar to all vector elements
 * @param lhs a scalar value to add to all elements
 ...
 * @return a new Vec4 with the results of the scalar addition
 */
DECL_BINARY_OP_NO_IMP(+, Vec4, float, const Vec4&)
 ...
 * @return true if the two vectors contain the same elements, false otherwise
 */
DECL_BINARY_OP_NO_IMP(==, bool, const Vec4&, const Vec4&)
/**
 * An != operator. Returns true if the two vectors do not contain the same elements, otherwise
 * returns false
 * @param lhs the left hand side Vec4
