...
{
    /**
     * A fuzzy equals comparison function. Checks if two 4D vectors are equal within a given tolerance level
    ...
    inline constexpr bool FEquals(const Vec<T, 4>& lhs, const Vec<T, 4>& rhs)
    {
        ...
        return (lhs.x - rhs.x <= epsilon) && (lhs.y - rhs.y <= epsilon) && (lhs.z - rhs.z <= epsilon) && (lhs.w - rhs.w <= epsilon);
    }

    /**
     * A fuzzy equals comparison function. Checks if two 3D vectors are equal within a given tolerance level
     * @tparam T the type of numerical value stored by the vector
     * @param lhs the vector on the left hand side of the operation
     * @param rhs the vector on the right hand side of the operation
     * @return a boolean specifying if they are equal within the given tolerance
    ...
    /**
     * A fuzzy equals comparison function. Checks if two 2D vectors are equal within a given tolerance level
     * @tparam T the type of numerical value stored by the vector
     * @param lhs the vector on the left hand side of the operation
     * @param rhs the vector on the right hand side of the operation
     * @return a boolean specifying if they are equal within the given tolerance
