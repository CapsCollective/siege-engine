...
DECL_VULKAN_SWITCH_FUN(PipelineStage,
                       ...
                       SWITCH_MEM(VkPipelineStageFlagBits, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, STAGE_TOP_OF_PIPE)
                           SWITCH_MEM(VkPipelineStageFlagBits, VK_PIPELINE_STAGE_VERTEX_SHADER_BIT, STAGE_VERTEX_SHADER)
                               SWITCH_MEM(VkPipelineStageFlagBits, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT, STAGE_FRAGMENT_SHADER)
                                   SWITCH_MEM(VkPipelineStageFlagBits, VK_PIPELINE_STAGE_TRANSFER_BIT, STAGE_TRANSFER_BIT)
                                       SWITCH_DEFAULT(STAGE_NONE))

DECL_VULKAN_SWITCH_FUN(VkPipelineStageFlagBits, PipelineStage,
...
DECL_VULKAN_SWITCH_FUN(VkAccessFlagBits, MemoryAccess,
...
DECL_VULKAN_SWITCH_FUN(MemoryAccess, VkAccessFlagBits,
...
DECL_VULKAN_SWITCH_FUN(ImageAspect, VkImageAspectFlagBits,
...
DECL_VULKAN_SWITCH_FUN(VkImageAspectFlagBits, ImageAspect,
       SWITCH_MEM(ImageAspect, ASPECT_COLOUR_BIT, VK_IMAGE_ASPECT_COLOR_BIT)
           SWITCH_MEM(ImageAspect, ASPECT_DEPTH_BIT, VK_IMAGE_ASPECT_DEPTH_BIT)
               SWITCH_MEM(ImageAspect, ASPECT_STENCIL_BIT, VK_IMAGE_ASPECT_STENCIL_BIT)
