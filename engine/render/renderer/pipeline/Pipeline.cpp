...
Utils::MHArray<char> Pipeline::ReadFile(const String& filePath)
{
    ...
    Utils::MHArray<char> buffer(size);
                                      ...
                                      const PipelineConfigInfo& configInfo)
{
    ...
    PipelineConfig::CreateDefaultPipelineStages(OUT shaderStages,
                                                stages,
                                                shaderModules,
                                                shaderCount);
...
void Pipeline::ClearPipeline()
{
    ...
    {
        vkDestroyShaderModule(Vulkan::Context::GetVkLogicalDevice(), shaderModules[i], nullptr);
    }

    vkDestroyPipeline(Vulkan::Context::GetVkLogicalDevice(), graphicsPipeline, nullptr);
}
...
void Pipeline::CreateShaderModule(Utils::MHArray<char>& fileData, VkShaderModule* shaderModule)
{
...
PipelineConfigInfo Pipeline::DefaultPipelineConfig()
{
    ...
    configInfo.viewportInfo = PipelineConfig::InitViewPortCreateInfo(1, nullptr, 1, nullptr);

    configInfo.rasterizationInfo =
        PipelineConfig::InitRasterizationCreateInfo(VK_FALSE,
                                                    VK_FALSE,
    ...
    configInfo.multisampleInfo = PipelineConfig::InitMultiSampleCreateInfo(VK_SAMPLE_COUNT_1_BIT,
                                                                           VK_FALSE,
                                                                           1.0f,
                                                                           nullptr,
                                                                           VK_FALSE,
    ...
    configInfo.colorBlendAttachment =
        PipelineConfig::InitColorBlendAttachment(VK_TRUE,
    ...
    configInfo.depthStencilInfo = PipelineConfig::InitDepthStencilCreateInfo(VK_TRUE,
                                                                             VK_TRUE,
                                                                             VK_COMPARE_OP_LESS,
                                                                             VK_FALSE,
                                                                             VK_FALSE);
