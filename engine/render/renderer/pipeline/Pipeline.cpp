...
HeapArray<char> Pipeline::ReadFile(const String& filePath)
{
...
void Pipeline::CreateShaderModule(HeapArray<char>& fileData, VkShaderModule* shaderModule)
{
