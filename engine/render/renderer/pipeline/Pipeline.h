...
struct PipelineConfigInfo
{
    ...
    HeapArray<VkDynamicState> dynamicStateEnables;
...
private:
     ...
     **/
    static HeapArray<char> ReadFile(const String& filePath);
     ...
     **/
    void CreateShaderModule(HeapArray<char>& fileData, VkShaderModule* shaderModule);
