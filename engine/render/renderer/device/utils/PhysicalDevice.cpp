                ...
                size_t deviceExtensionCount)
{
    ...
    bool extensionsSupported = Vulkan::Device::Physical::SupportsExtensions(device, deviceExtensions, deviceExtensionCount);
    ...
    VkPhysicalDeviceFeatures supportedFeatures = Vulkan::Device::Physical::GetDeviceFeatures(device);
    ...
    return indicesSupported && extensionsSupported && swapChainAdequate && supportedFeatures.samplerAnisotropy;
}
} // namespace Siege::PhysicalDevice