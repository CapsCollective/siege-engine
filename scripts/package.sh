...
# Require at least three arguments for package name, output, and binary path
if [ $# -lt 3 ]; then
    echo "Requires at least three arguments (e.g. package.sh <package_name> <output_dir> <bin_dir> [--include-validation-layers])"
    exit 1
fi
