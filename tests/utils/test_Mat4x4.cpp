...
UTEST(test_Matrix4x4, CreateMatrixWithValues)
{
    ...
    Siege::Mat::Mat4x4 matrix = {{1.f, 2.f, 3.f, 4.f},
                                 {5.f, 6.f, 7.f, 8.f},
                                 {9.f, 10.f, 11.f, 12.f},
                                 {13.f, 14.f, 15.f, 16.f}};
...
UTEST(test_Matrix4x4, CreateIdentityMatrix)
{
    ...
    Siege::Mat::Mat4x4 matrix = Siege::Mat::Mat4x4::Identity;
...
{
    Siege::Mat::Mat4x4 matrixA = Siege::Mat::Mat4x4::Identity;
    Siege::Mat::Mat4x4 matrixB = {matrixA};
...
{
    Siege::Mat::Mat4x4 matrixA = Siege::Mat::Mat4x4::Identity;
    Siege::Mat::Mat4x4 matrixB = {};
    Siege::Mat::Mat4x4 matrixC = matrixA;

    ASSERT_TRUE(matrixA == matrixC);
    ASSERT_FALSE(matrixA == matrixB);
    ASSERT_TRUE(matrixB == Siege::Mat::Mat4x4::Zero);
...
UTEST(test_Matrix4x4, AddMatrices)
{
    ...
    Siege::Mat::Mat4x4 matrixA = {{1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f}};

    Siege::Mat::Mat4x4 matrixB = {{1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f},
                                  {1.f, 1.f, 1.f, 1.f}};
...
{
    Siege::Mat::Mat4x4 expected = Siege::Mat::Mat4x4::Zero;
...
UTEST(test_Matrix4x4, SubtractMatricesAndReturnNewMatrix)
{
    ...
    Siege::Mat::Mat4x4 matrixC = matrixA - matrixB;
...
{
    Siege::Mat::Mat4x4 expected = {{3.f, 3.f, 3.f, 3.f},
                                   {3.f, 3.f, 3.f, 3.f},
                                   {3.f, 3.f, 3.f, 3.f},
                                   {3.f, 3.f, 3.f, 3.f}};

    Siege::Mat::Mat4x4 matrix = {{1.f, 1.f, 1.f, 1.f},
                                 {1.f, 1.f, 1.f, 1.f},
                                 {1.f, 1.f, 1.f, 1.f},
                                 {1.f, 1.f, 1.f, 1.f}};
...
UTEST(test_Matrix4x4, MultiplyByScalarUsingEqualsOperator)
{
    ...
    Siege::Mat::Mat4x4 matrixB = matrix * 3.f;
...
{
    Siege::Mat::Mat4x4 expected = {{43.f, 45.f, 47.f, 49.f},
                                   {37.f, 35.f, 33.f, 31.f},
                                   {107.f, 109.f, 111.f, 113.f},
                                   {101.f, 99.f, 97.f, 95.f}};

    Siege::Mat::Mat4x4 matrixA = {{1.f, 2.f, 3.f, 4.f},
                                  {4.f, 3.f, 2.f, 1.f},
                                  {5.f, 6.f, 7.f, 8.f},
                                  {8.f, 7.f, 6.f, 5.f}};

    Siege::Mat::Mat4x4 matrixB = {{4.f, 3.f, 2.f, 1.f},
                                  {1.f, 2.f, 3.f, 4.f},
                                  {7.f, 6.f, 5.f, 4.f},
                                  {4.f, 5.f, 6.f, 7.f}};
...
{
    Siege::Vec::Vec4 expected {14, 16, 38, 40};

    Siege::Vec::Vec4 vector = {2, 1, 2, 1};
    Siege::Mat::Mat4x4 matrix = {{1.f, 2.f, 3.f, 4.f},
                                 {4.f, 3.f, 2.f, 1.f},
                                 {5.f, 6.f, 7.f, 8.f},
                                 {8.f, 7.f, 6.f, 5.f}};

    Siege::Vec::Vec4 result = matrix.Multiply(vector);
...
UTEST(test_Matrix4x4, MultiplyVectorWithTimesOperator)
{
    ...
    Siege::Vec::Vec4 result = matrix * vector;
...
UTEST(test_Matrix4x4, CalculateDeterminant)
{
    ...
    Siege::Mat::Mat4x4 matrix0 = {{5, 2, 3, 6}, {8, 4, 2, 8}, {4, 6, 9, 2}, {3, 6, 9, 2}};
    expectedDeterminant = 128.f;
    determinant = matrix0.Determinant();
    ASSERT_EQ(expectedDeterminant, determinant);

    determinant = Siege::Mat::Mat4x4::Determinant(matrix0);
    ASSERT_EQ(expectedDeterminant, determinant);
}

UTEST(test_Matrix4x4, CalculateInverse)
{
    Siege::Mat::Mat4x4 expected = {{0.f, 0.f, 1.f, -1.f},
                                   {-0.53125f, 0.375f, -0.625f, 0.71875f},
                                   {0.3125f, -0.25f, 0.25f, -0.1875f},
                                   {0.1875f, 0.f, -0.75f, 0.6875f}};

    Siege::Mat::Mat4x4 matrix = {{5, 2, 3, 6}, {8, 4, 2, 8}, {4, 6, 9, 2}, {3, 6, 9, 2}};

    Siege::Mat::Mat4x4 result = matrix.Inverse();
    ...
    result = Siege::Mat::Mat4x4::Inverse(matrix);
...
{
    Siege::Mat::Mat4x4 expected = Siege::Mat::Mat4x4::Identity;

    Siege::Mat::Mat4x4 matrixA = {{5.f, 2.f, 3.f, 6.f},
                                  {8.f, 4.f, 2.f, 8.f},
                                  {4.f, 6.f, 9.f, 2.f},
                                  {3.f, 6.f, 9.f, 2.f}};

    Siege::Mat::Mat4x4 matrixB = {{5.f, 2.f, 3.f, 6.f},
                                  {8.f, 4.f, 2.f, 8.f},
                                  {4.f, 6.f, 9.f, 2.f},
                                  {3.f, 6.f, 9.f, 2.f}};
...
UTEST(test_Matrix4x4, DivideMatrixWithSlashOperator)
{
    ...
    Siege::Mat::Mat4x4 result = matrixA / matrixB;
...
{
    Siege::Mat::Mat4x4 expected = {{1.f, 5.f, 9.f, 13},
                                   {2.f, 6.f, 10.f, 14.f},
                                   {3.f, 7.f, 11.f, 15.f},
                                   {4.f, 8.f, 12.f, 16.f}};
    ...
    Siege::Mat::Mat4x4 transposed = matrix.Transpose();
    Siege::Mat::Mat4x4 transposedS = Siege::Mat::Mat4x4::Transpose(matrix);
...
{
    Siege::Mat::Mat4x4 expected = {{1.f, -1.f, 1.f, -1.f},
                                   {-1.f, 1.f, -1.f, 1.f},
                                   {1.f, -1.f, 1.f, -1.f},
                                   {-1.f, 1.f, -1.f, 1.f}};
