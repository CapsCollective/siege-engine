...
UTEST(test_Matrix3x3, CreateMatrixWithValues)
{
    ...
    Siege::Mat::Mat3x3 matrix = {{1.f, 2.f, 3.f}, {2.f, 4.f, 5.f}, {6.f, 7.f, 9.f}};
...
UTEST(test_Matrix3x3, CreateIdentityMatrix)
{
    ...
    Siege::Mat::Mat3x3 matrix = Siege::Mat::Mat3x3::Identity;
...
{
    Siege::Mat::Mat3x3 matrixA = Siege::Mat::Mat3x3::Identity;
    Siege::Mat::Mat3x3 matrixB = {matrixA};
...
{
    Siege::Mat::Mat3x3 matrixA = Siege::Mat::Mat3x3::Identity;
    Siege::Mat::Mat3x3 matrixB = {};
    Siege::Mat::Mat3x3 matrixC = matrixA;

    ASSERT_TRUE(matrixA == matrixC);
    ASSERT_FALSE(matrixA == matrixB);
    ASSERT_TRUE(matrixB == Siege::Mat::Mat3x3::Zero);
...
UTEST(test_Matrix3x3, AddMatrices)
{
    ...
    Siege::Mat::Mat3x3 matrixA = {{1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}};
    Siege::Mat::Mat3x3 matrixB = {{1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}};
...
{
    Siege::Mat::Mat3x3 expected = Siege::Mat::Mat3x3::Zero;
...
UTEST(test_Matrix3x3, SubtractMatricesAndReturnNewMatrix)
{
    ...
    Siege::Mat::Mat3x3 matrixC = matrixA - matrixB;
...
{
    Siege::Mat::Mat3x3 expected = {{3.f, 3.f, 3.f}, {3.f, 3.f, 3.f}, {3.f, 3.f, 3.f}};
    Siege::Mat::Mat3x3 matrix = {{1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}, {1.f, 1.f, 1.f}};
...
UTEST(test_Matrix3x3, MultiplyByScalarUsingEqualsOperator)
{
    ...
    Siege::Mat::Mat3x3 matrixB = matrix * 3.f;
...
{
    Siege::Mat::Mat3x3 expected = {{26.f, 24.f, 22.f}, {18.f, 16.f, 14.f}, {70.f, 64.f, 58.f}};
    Siege::Mat::Mat3x3 matrixA = {{1.f, 2.f, 3.f}, {3.f, 2.f, 1.f}, {5.f, 6.f, 7.f}};
    Siege::Mat::Mat3x3 matrixB = {{3.f, 2.f, 1.f}, {1.f, 2.f, 3.f}, {7.f, 6.f, 5.f}};
...
{
    Siege::Vec::Vec3 expected {10, 10, 30};

    Siege::Vec::Vec3 vector = {2, 1, 2};
    Siege::Mat::Mat3x3 matrix = {{1.f, 2.f, 3.f}, {3.f, 2.f, 1.f}, {5.f, 6.f, 7.f}};

    Siege::Vec::Vec3 result = matrix.Multiply(vector);
...
UTEST(test_Matrix3x3, MultiplyVectorWithTimesOperator)
{
    ...
    Siege::Vec::Vec3 result = matrix * vector;
...
UTEST(test_Matrix3x3, CalculateDeterminant)
{
    ...
    Siege::Mat::Mat3x3 matrix0 = {{5.f, 2.f, 3.f}, {3.f, 6.f, 1.f}, {5.f, 6.f, 7.f}};
    expectedDeterminant = 112.f;
    determinant = matrix0.Determinant();
    ASSERT_EQ(expectedDeterminant, determinant);

    determinant = Siege::Mat::Mat3x3::Determinant(matrix0);
    ASSERT_EQ(expectedDeterminant, determinant);
}

UTEST(test_Matrix3x3, CalculateInverse)
{
    Siege::Mat::Mat3x3 expected = {{0.2142857f, -0.0357142f, -0.0357142f},
                                   {-0.0357142f, 0.2142857f, -0.0357142f},
                                   {-0.0357142f, -0.0357142f, 0.2142857f}};

    Siege::Mat::Mat3x3 matrix = {{5.f, 1.f, 1.f}, {1.f, 5.f, 1.f}, {1.f, 1.f, 5.f}};

    Siege::Mat::Mat3x3 result = matrix.Inverse();
    ...
    result = Siege::Mat::Mat3x3::Inverse(matrix);
...
{
    Siege::Mat::Mat3x3 expected = {{9.f, -3.f, -5.f},
                                   {5.f, 1.f, -5.f},
                                   {-2.33333333333, -0.333333333333, 3.f}};

    Siege::Mat::Mat3x3 matrixA = {{2.f, 4.f, 6.f}, {1.f, 5.f, 6.f}, {2.f, 4.f, 7.f}};

    Siege::Mat::Mat3x3 matrixB = {{5.f, 1.f, 1.f}, {1.f, 5.f, 1.f}, {1.f, 1.f, 5.f}};
...
UTEST(test_Matrix3x3, DivideMatrixWithSlashOperator)
{
    ...
    Siege::Mat::Mat3x3 result = matrixA / matrixB;
...
{
    Siege::Mat::Mat3x3 expected = {{1.f, -1.f, 1.f}, {-1.f, 1.f, -1.f}, {1.f, -1.f, 1.f}};
...
{
    Siege::Mat::Mat3x3 expected = {{1.f, 4.f, 7.f}, {2.f, 5.f, 8.f}, {3.f, 6.f, 9.f}};

    Siege::Mat::Mat3x3 matrix = {{1.f, 2.f, 3.f}, {4.f, 5.f, 6.f}, {7.f, 8.f, 9.f}};

    Siege::Mat::Mat3x3 transposed = matrix.Transpose();
